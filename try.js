...
$(document).ready(function(){
 ...
 //Upload
 $("#myModal_UploadTemplate").modal('show');
    var xhttp = new XMLHttpRequest();
    xhttp.withCredentials = true
    xhttp.onreadystatechange = function() {
    if (xhttp.readyState === 2) {	
       ...
       console.log(FILE);
       xhttp.open('POST', 'https://john.smith:Accenture01@lisa.accenture.com/jenkins/job/refarch-instance/job/Ref_Upload/buildWithParameters?token=qEJqHj3b&FILE='+FILE, true)
       xhttp.setRequestHeader('Content-Type', 'text/plain;charset=UTF-8');
       xhttp.send();
